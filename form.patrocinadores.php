					...
					<div class="col-sm-12">
						<div class="item-wrap">
							<div class="row">
								...
								<div class="col-md-12">
								<form id="contactForm" name="contactform" class="popup-form" action="/patrocinadores.php" method="POST">
									<div class="row">
										<div id="msgContactSubmit" class="hidden"></div>
										<div class="form-group col-sm-6">
											<div class="help-block with-errors"></div>
											<input name="empresa" id="empresa" placeholder="Empresa*" class="form-control" type="text" required data-error="Por favor escribe el nombre de la empresa" />
